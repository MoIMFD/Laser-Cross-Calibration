...
class CoordinateSystem:
    ...
    def __post_init__(self):
        ...
        if not self._is_orthonormal(self.basis, tolerance=1e-8):
            raise ValueError(f"Coordinate system '{self.name}' basis is not orthonormal")
    ...
    def globalize(self, local_point: POINT3) -> POINT3:
        ...
        parent_point = self.basis.T @ local_point + self.origin  # basis.T for inverse transform
